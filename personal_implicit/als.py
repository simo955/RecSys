...
from personal_implicit._als import _als
from personal_implicit.recommender_base import MatrixFactorizationBase
from personal_implicit.utils import check_blas_config, nonzeros
...
class AlternatingLeastSquares(MatrixFactorizationBase):
    ...
    def __init__(self, dtype=np.float32, use_native=True, use_cg=True, use_gpu=False ,calculate_training_loss=False, num_threads=0):
    ...
    def fit(self, item_users, factors=100, regularization=0.01, iterations=15, show_progress=True):
