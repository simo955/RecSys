...
class ItemKNNScoresHybridRecommender4(Recommender):
    """ ItemKNNScoresHybridRecommender4
    Hybrid of two prediction scores R = R1*alpha + R2*(1-alpha)

    """

    RECOMMENDER_NAME = "ItemKNNScoresHybridRecommender4"

    def __init__(self, URM_train, Recommender_1, Recommender_2, Recommender_3, Recommender_4):
        super(ItemKNNScoresHybridRecommender4, self).__init__()
    ...
    def fit(self, alpha=0.5, beta =0.3, gamma =0.1, delta=0.1):
        self.alpha = alpha
        self.beta = beta
        self.gamma = gamma
        self.delta = delta
