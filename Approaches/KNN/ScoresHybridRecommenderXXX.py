...
class ScoresHybridRecommenderXXX(Recommender):
    """ ScoresHybridRecommenderXXX
    Hybrid of two prediction scores R = R1*alpha + R2*(1-alpha)

    """

    RECOMMENDER_NAME = "ScoresHybridRecommenderXXX"


    def __init__(self, URM_train, Recommender_1, weightRec2):
        super(ScoresHybridRecommenderXXX, self).__init__()

        self.URM_train = check_matrix(URM_train.copy(), 'csr')
        self.Recommender_1 = Recommender_1
        self.weightRec2 = weightRec2
    ...
    def compute_score_hybrid(self, user_id_array):
        ...
        item_weights_2 = self.weightRec2[user_id_array]
